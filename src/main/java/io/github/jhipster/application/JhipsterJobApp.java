...
public class JhipsterJobApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterJobApp.class);

    private final Environment env;

    public JhipsterJobApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterJobApp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterJobApp.class);
